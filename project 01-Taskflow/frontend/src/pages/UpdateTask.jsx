...
export default function UpdateTask() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${backendUrl}/api/task/updateTask`, {
        method: "POST",
        headers: {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col-reverse gap-3 pt-2 sm:flex-row sm:justify-end">
              <button
                ...
                className="inline-flex cursor-pointer items-center justify-center rounded-lg border border-gray-200 px-5 py-3 text-sm font-semibold text-gray-600 transition hover:bg-gray-50 disabled:opacity-60"
              >
                Cancel
              </button>
